 ...
 * it easier e.g. to set different parts of a query independently. The from part of the query is ignored
 *
 * @package    Erfurt_Sparql
 * @author     Norman Heino <norman.heino@gmail.com>
 * @author     Philipp Frischmuth <pfrischmuth@googlemail.com>
 * @author     Karel Kremer <karel.kremer@tenforce.com>
 * @copyright  Copyright (c) 2012, {@link http://aksw.org AKSW}
 * @license    http://opensource.org/licenses/gpl-license.php GNU General Public License (GPL)
 */
class CubeViz_FromlessQuery extends Erfurt_Sparql_SimpleQuery
{    
    // ------------------------------------------------------------------------
