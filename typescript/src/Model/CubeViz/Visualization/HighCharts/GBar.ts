...
class CubeViz_Visualization_HighCharts_GBar extends CubeViz_Visualization_HighCharts_Chart 
{
    ...
    public shouldHideElement(element:any, selectedAttributeUri:string, seriesElement:bool) :bool {
	if(seriesElement){
	    //TODO handle zooming
	    //this.counter++;
	    ...
	    //TODO handle zooming
	    // return false === _.isNull(selectedAttributeUri) && 
            //     (true === _.isNull(element[selectedAttributeUri]) || true === _.isUndefined(element[selectedAttributeUri])) && 
            //     selectedAttributeUri !== element ["http://purl.org/linked-data/cube#attribute"];
	}
    };
	...
	var self:any = this;
	    ...
	    if(self.shouldHideElement(seriesElement,selectedAttributeUri,true)){
		return;
	    }
            ...
            _.each(seriesElement.observations, function(seriesObservation){
                ...
                if (self.shouldHideElement(seriesObservation, selectedAttributeUri, false))
                {
                    // TODO implement a way to handle ignored observations
                    return;
                }
